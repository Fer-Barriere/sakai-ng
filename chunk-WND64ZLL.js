import{Ha as R,qa as A,ra as g,xa as P}from"./chunk-KKM2KR3K.js";import{Bb as S,Cb as z,Da as o,Ib as B,Oa as b,P as v,Pa as C,Q as h,Sa as $,Ua as k,V as T,Va as r,Yb as Q,bb as i,eb as I,fa as p,fb as x,kb as u,lb as d,mb as M,mc as E,nb as w,ob as F,oc as N,qc as O,sc as q,tb as l,ub as D,vb as j,wb as f,yb as m,zb as y}from"./chunk-2HC2GL3M.js";var H=["icon"],G=["*"];function J(e,c){if(e&1&&M(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function K(e,c){if(e&1&&(w(0),r(1,J,1,1,"span",3),F()),e&2){let t=l();o(),i("ngIf",t.icon)}}function L(e,c){}function U(e,c){e&1&&r(0,L,0,0,"ng-template")}function W(e,c){if(e&1&&(u(0,"span",5),r(1,U,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var X=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
